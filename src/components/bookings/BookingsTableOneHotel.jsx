...
import { getBookingsByHotelId, cancelBooking ,getHotelsByManagerEmail} from "../utils/ApiFunctions"; // Import các hàm cần thiết
import { useAuth } from "../auth/AuthProvider"; // Import useAuth
import DateSlider from "../common/DateSlider";

const BookingsTableOneHotel = ({ hotelId }) => {
  const { user } = useAuth();
  ...
  const handleCancelBooking = async (bookingId) => {
    if (bookingId) {
      try {
        ...
        fetchBookings(selectedHotelId); // Refresh bookings after cancellation
      } catch (error) {
